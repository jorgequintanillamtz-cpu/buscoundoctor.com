...
- Pendiente conocido: cambiar el nombre de un doctor regenera su `slug` (y por tanto su URL pública) mientras `_slugManual` no esté puesto (`update` en `useSpecialistForm`); habría que fijarlo al crear el perfil.
