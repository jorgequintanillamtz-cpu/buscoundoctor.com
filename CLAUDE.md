...
- Migraciones aplicadas en Supabase (no están en git): `doctor_settings_email_prefs_and_deletion_request`, `doctor_settings_notice_email_and_vacation`, `doctor_settings_reviews_email_and_data_export`, `specialist_assistant_access`, `fix_invite_assistant_crypt_schema`.
