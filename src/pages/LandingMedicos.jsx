...
import {
  ...
  ArrowRight, BadgeCheck, MessageCircle, Clock, Crown, Tag,
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="relative bg-card border border-border/50 rounded-3xl overflow-hidden p-6 sm:p-10 shadow-sm">
            ...
            <div className="relative grid md:grid-cols-[auto,1fr] gap-6 md:gap-8 items-center">
              <div className="flex justify-center md:justify-start">
                <img src="/logo.webp" alt="" loading="lazy" className="h-14 sm:h-16 w-auto object-contain flex-shrink-0" />
              </div>
              <div className="text-center md:text-left">
                ...
                <CtaButton className="h-12 px-8">Aceptar oferta</CtaButton>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* ============ RESUMEN + CTA FINAL ============ */}
        <section aria-labelledby="cta-final-heading" className="bg-brand-navy max-w-4xl mx-auto px-4 sm:px-6 pb-16 sm:pb-20 lg:max-w-none lg:px-0">
