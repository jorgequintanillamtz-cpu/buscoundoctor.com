    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section aria-labelledby="cta-final-heading" className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <h2 id="cta-final-heading" className="font-heading font-extrabold text-3xl sm:text-4xl text-foreground tracking-tight flex flex-wrap items-center justify-center gap-x-2.5 gap-y-1">
            <span>Tu próximo paciente ya te está buscando en</span>
            <span className="inline-flex items-center gap-2">
              <svg className="w-7 h-7 sm:w-9 sm:h-9 flex-shrink-0" viewBox="0 0 48 48" aria-hidden="true">
            ...
            <span>y</span>
            <span className="inline-flex items-center gap-2">
              <svg className="w-7 h-7 sm:w-9 sm:h-9 flex-shrink-0 text-foreground" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
