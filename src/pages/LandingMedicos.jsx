          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <h1 id="hero-heading" className="font-heading font-extrabold text-4xl sm:text-5xl leading-[1.1] text-foreground tracking-tight">
                ...
                <span className="flex flex-nowrap items-center justify-center lg:justify-start gap-x-1.5 text-xl sm:text-3xl mt-1">
                  <span className="inline-flex items-center gap-1">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 flex-shrink-0" viewBox="0 0 48 48" aria-hidden="true">
                  ...
                  <span>y</span>
                  <span className="inline-flex items-center gap-1">
                    <svg className="w-4 h-4 sm:w-6 sm:h-6 flex-shrink-0 text-foreground" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
