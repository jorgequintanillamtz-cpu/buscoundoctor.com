        ...
        <section ref={heroRef} aria-labelledby="hero-heading" className="relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              <h1 id="hero-heading" className="font-heading font-extrabold text-4xl sm:text-5xl leading-[1.1] text-foreground tracking-tight flex flex-wrap items-center justify-center lg:justify-start gap-x-2.5 gap-y-1">
                <span>Tu próximo paciente en <span className="text-brand-blue">Monterrey y San Pedro</span> ya te está buscando en</span>
                <span className="inline-flex items-center gap-2">
                  <svg className="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0" viewBox="0 0 48 48" aria-hidden="true">
                ...
                <span>y</span>
                <span className="inline-flex items-center gap-2">
                  <svg className="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 text-foreground" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
