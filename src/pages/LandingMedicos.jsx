      ...
      <main>
        ...
        <section aria-labelledby="cta-final-heading" className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20 text-center">
          ...
          <h2 id="cta-final-heading" className="font-heading font-extrabold text-3xl sm:text-4xl text-foreground tracking-tight">
            Tu próximo paciente ya te está buscando en Google y ChatGPT
          </h2>

          {/* Logos reales de Google y ChatGPT, mismo tratamiento que en el home. */}
          <div className="mt-4 flex flex-wrap items-center justify-center gap-x-1.5 gap-y-1 text-sm text-foreground font-medium">
            <span className="text-muted-foreground">Aparece en</span>
            ...
            <span className="inline-flex items-center gap-1">
              <svg className="w-4 h-4 flex-shrink-0 text-foreground" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
