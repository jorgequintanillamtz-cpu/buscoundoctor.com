...
export default function AdminDoctorStats() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        <div>
          <h1 className="font-heading font-bold text-2xl text-foreground">Estadísticas de médicos</h1>
          <p className="text-sm text-muted-foreground mt-0.5">Impresiones, clicks al perfil y citas agendadas</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Top doctores */}
        <div className="bg-card rounded-2xl border border-border/50 p-5">
          <h2 className="font-heading font-semibold text-sm text-foreground mb-4">Top doctores por citas agendadas (este mes)</h2>
          {topDoctors.length === 0 ? (
        ...
        {/* Clicks por origen */}
        <div className="bg-card rounded-2xl border border-border/50 p-5">
          <h2 className="font-heading font-semibold text-sm text-foreground mb-4">Clicks al perfil por origen (este mes)</h2>
